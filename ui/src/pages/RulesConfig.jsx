  ...
  const fetchSettings = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setGeminiApiKey(data.gemini_api_key_masked || "");
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem", background: "rgba(255,255,255,0.01)", padding: "1rem", borderRadius: "8px", border: "1px solid rgba(255,255,255,0.03)" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                      ...
                      <label htmlFor="ai_enabled" style={{ fontSize: "0.85rem", color: "#fff", cursor: "pointer" }}>
                        Enable AI Advisor
                        <Tooltip text="If checked, this table's anomalies will automatically trigger root-cause analysis via the Gemini/Groq LLM." />
                      </label>
                    </div>
                    <div>
                      <label style={{ display: "block", fontSize: "0.8rem", color: "var(--text-muted)", marginBottom: "0.4rem" }}>
                      ...
                      <input
                        type="text"
                        value={tableRules.ai_advisor?.model || "gemini-2.0-flash"}
          ...
          {settingsLoading ? (
            ...
            <form onSubmit={handleSaveSettings} style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                ...
                <input
                  type="password"
                  placeholder="Enter Gemini Key or Groq Key (starts with gsk_)"
                  value={geminiApiKey}
                ...
                <span style={{ fontSize: "0.75rem", color: "var(--text-muted)" }}>
                  Your API key is stored securely in Elasticsearch. Supports Google Gemini keys and Groq API keys (starts with gsk_).
                </span>
              </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                ...
                >
                  <optgroup label="Google Gemini Models">
                    <option value="gemini-1.5-flash">Gemini 1.5 Flash (Recommended - Fast & Cost-effective)</option>
                    <option value="gemini-1.5-pro">Gemini 1.5 Pro (Highly Intelligent - Complex reasoning)</option>
                    <option value="gemini-2.0-flash">Gemini 2.0 Flash (Latest Preview)</option>
                  </optgroup>
                  <optgroup label="Groq Llama Models">
                    <option value="llama-3.3-70b-versatile">Groq Llama 3.3 70B (Default for Groq - Powerful & Fast)</option>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", background: "rgba(255,255,255,0.01)", padding: "1rem", borderRadius: "8px", border: "1px solid rgba(255,255,255,0.03)" }}>
                ...
                <div style={{ cursor: "pointer" }}>
                  <label htmlFor="gemini_enabled" style={{ fontSize: "0.85rem", color: "#fff", fontWeight: 600, display: "block" }}>
                    Enable AI Advisor
                  </label>
